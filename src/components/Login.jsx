      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-10 text-center transform transition-all duration-500">
          <div className="mb-6 inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-emerald-50 dark:bg-emerald-950 border border-emerald-200 dark:border-emerald-800 animate-fade-in-up transition-colors duration-300">
            ...
            <span className="text-xs font-medium tracking-widest text-emerald-700 dark:text-emerald-300">⚡ WELCOME BACK</span>
          </div>
          ...
          <p className="text-gray-600 dark:text-gray-400 font-light transition-colors duration-300">Continue with your enterprise power solutions</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg dark:shadow-xl p-8 md:p-10 border border-gray-200 dark:border-slate-700 backdrop-blur transition-all duration-300">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex justify-end pt-1">
              <a href="#" className="text-sm text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 font-medium transition-colors duration-300">
                Forgot password?
              </a>
            </div>
          ...
          <div className="space-y-3">
            <p className="text-center text-sm text-gray-600 dark:text-gray-400 font-light transition-colors duration-300">Continue with</p>
